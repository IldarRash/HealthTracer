---
name: test-writer
description: Write focused tests for domain services, API integration, Zod schemas, AI proposals, frontend states, and regression cases. Use when adding tests or validating feature implementation.
...
7. Run the narrowest useful validation command.
