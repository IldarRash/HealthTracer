...
export const recipes = pgTable(
  "recipes",
  {
    ...
    proteinGramsPerServing: integer("protein_grams_per_serving").notNull(),
    carbsGramsPerServing: integer("carbs_grams_per_serving").notNull(),
    fatGramsPerServing: integer("fat_grams_per_serving").notNull(),
    fiberGramsPerServing: integer("fiber_grams_per_serving"),
