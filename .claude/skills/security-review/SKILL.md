...
- AI tools cannot mutate domain state directly; every proposal is validated before persistence.
...
- Context safety floors (documents / sensitive health context denied by default) are not relaxed by config.
