  ...
  private async executeSearchRecipeCatalog(
    ...
    const result: SearchRecipeCatalogResult = {
      items: capped.map((recipe) => ({
        ...
        estimatedCalories: recipe.perServingMacros?.caloriesPerServing ?? null,
        proteinGrams: recipe.perServingMacros?.proteinGramsPerServing ?? null,
        carbsGrams: recipe.perServingMacros?.carbsGramsPerServing ?? null,
        fatGrams: recipe.perServingMacros?.fatGramsPerServing ?? null,
        tags: recipe.tags ?? [],
