...
export const biomarkerReadings = pgTable(
  "biomarker_readings",
  {
    ...
    referenceRangeLow: numeric("reference_range_low", { precision: 12, scale: 4 }),
    referenceRangeHigh: numeric("reference_range_high", { precision: 12, scale: 4 }),
    optimalRangeLow: numeric("optimal_range_low", { precision: 12, scale: 4 }),
    optimalRangeHigh: numeric("optimal_range_high", { precision: 12, scale: 4 }),
    observedAt: timestamp("observed_at", { withTimezone: true }),
